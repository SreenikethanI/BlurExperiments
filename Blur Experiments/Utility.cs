...
namespace Blur_Experiments
{
    ...
    /// For <see cref="int"/>, prefer using <seealso cref="KernelInt"/>.
    /// For <see cref="float"/>, prefer using <seealso cref="KernelFloat"/>.</summary>
    ...
    /// <summary>A kernel for use in image processing, with <see cref="int"/> elements.</summary>
    ...
    /// <summary>A kernel for use in image processing, with <see cref="float"/> elements.</summary>
